...
class SEDU_Net_D3(nn.Module):
    def __init__(self, in_channels=3, out_channels=5):
        ...
        self.dense_block = DenseBlock(256, 512)
        self.decoder = Decoder(512)
        self.final_conv = nn.Conv2d(64, out_channels, kernel_size=1)

        # Load VGG16 weights
        vgg16 = models.vgg16(pretrained=True)
        self._load_vgg16_weights(vgg16)

    def _load_vgg16_weights(self, vgg16):
        features = list(vgg16.features.children())
        self.encoder.conv1.conv1.weight.data = features[0].weight.data
        self.encoder.conv1.conv1.bias.data = features[0].bias.data
        self.encoder.conv1.conv2.weight.data = features[2].weight.data
        self.encoder.conv1.conv2.bias.data = features[2].bias.data

        self.encoder.conv2.conv1.weight.data = features[5].weight.data
        self.encoder.conv2.conv1.bias.data = features[5].bias.data
        self.encoder.conv2.conv2.weight.data = features[7].weight.data
        self.encoder.conv2.conv2.bias.data = features[7].bias.data

        self.encoder.conv3.conv1.weight.data = features[10].weight.data
        self.encoder.conv3.conv1.bias.data = features[10].bias.data
        self.encoder.conv3.conv2.weight.data = features[12].weight.data
        self.encoder.conv3.conv2.bias.data = features[12].bias.data
        self.encoder.conv3.conv3.weight.data = features[14].weight.data
        self.encoder.conv3.conv3.bias.data = features[14].bias.data
